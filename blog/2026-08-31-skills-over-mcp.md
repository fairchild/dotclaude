...
A host that doesn't know the extension sees ordinary MCP resources: an unmodified Claude Code session consumed the server as plain resources, paginating 400-odd files without knowing skills were involved.
