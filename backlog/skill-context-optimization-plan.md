...
- https://github.com/anthropics/claude-code/issues/16616
...
- https://github.com/anthropics/claude-code/issues/18840
...
**Files to modify:**
- `~/.claude/commands/*.md` — remove duplicates
...
- `~/.claude/skills/team-memory/references/design.md` — Key Insight section on system prompt
