...
| `skill_competition.py` | Create manual skill-vs-baseline run packs from `evals/evals.json` (`uv run --script scripts/skill_competition.py --challenger <skill> --baseline none`) |
