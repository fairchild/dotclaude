...
Override the location with (script path relative to the skill's base directory):

```bash
VOCAL_DATA_DIR=/path/to/private/vocal-data uv run --script scripts/web_console.py
```
