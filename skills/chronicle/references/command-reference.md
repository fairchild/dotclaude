...
Render the table inline in the response — the user shouldn't have to open a file. Cite section anchors in this reference when they ask follow-up questions about a specific command.
